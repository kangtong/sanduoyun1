  ...
  >
    <div class="video1container" v-if="lang && video1show">
      <video
        ...
        autoplay
        muted
        src="../../assets/videos/cn/数字杆站-2-入场.mp4"
      ></video>
    </div>
    <div class="video2container" v-show="lang && video2show">
      <video
        ...
        loop
        muted
        src="../../assets/videos/cn/数字杆站-2-循环.mp4"
      ></video>
    </div>
    ...
    <div class="video1container" v-if="!lang && video1show">
      <video
          ...
          autoplay
          muted
          src="../../assets/videos/en/数字杆站-2-入场.mp4"
      ></video>
    </div>
    <div class="video2container" v-show="!lang && video2show">
      <video
          ...
          loop
          muted
          src="../../assets/videos/en/数字杆站-2-循环.mp4"
      ></video>
    </div>
...
export default {
  ...
  methods: {
    ...
    init(){
      var flat = localStorage.getItem("jiance");
