  ...
  >
    <div class="video1container" v-show="video1show">
      <video
        ...
        @ended="video1end"
        muted
        src="../../assets/videos/cn/SaaS应用本地化部署ASIS.mp4"
      ></video>
      <video
        v-show="!lang"
        class="home_video"
        ...
        @ended="video1end"
        muted
        src="../../assets/videos/en/SaaS应用本地化部署ASIS_EN.mp4"
      ></video>
    </div>
    <div class="video2container" v-show="video2show">
      <video
        ...
        loop
        muted
        src="../../assets/videos/cn/SaaS应用本地化部署ASIS2.mp4"
      ></video>
      <video
        v-show="!lang"
        class="video"
        ...
        loop
        muted
        src="../../assets/videos/en/SaaS应用本地化部署ASIS2_EN.mp4"
      ></video>
    </div>
    <!-- 切换到tobe页面 -->
    <div class="tobe_btn" @click="$router.push({ path:'saastobe', query: $route.query})"></div>
    <!-- 返回到上一页 -->
