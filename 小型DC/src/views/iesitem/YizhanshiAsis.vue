<template>
  ...
  >
    <video
      ...
      loop
      muted
      src="../../assets/videos/cn/一站式大数据ASIS.mp4"
    ></video>
    <video
      v-show="!lang"
      class="home_video"
      ...
      loop
      muted
      src="../../assets/videos/en/一站式大数据ASIS_EN.mp4"
    ></video>
    <!-- 切换到tobe页面 -->
    <div class="tobe_btn" @click="$router.push({ path:'yizhanshitobe', query: $route.query})"></div>
    <!-- 返回到上一页 -->
