  ...
  >
    <div class="video1container" v-if="lang && video1show">
      <video
        ...
        autoplay
        muted
        src="../../assets/videos/cn/CLF入场.mp4"
      ></video>
    </div>
    <div class="video2container" v-show="lang && video2show">
      <video
        ...
        loop
        muted
        src="../../assets/videos/cn/CLF循环.mp4"
      ></video>
    </div>
    ...
    <div class="video1container" v-if="!lang && video1show">
      <video
          ...
          autoplay
          muted
          src="../../assets/videos/en/CLF入场.mp4"
      ></video>
    </div>
    <div class="video2container" v-show="!lang && video2show">
      <video
          ...
          loop
          muted
          src="../../assets/videos/en/CLF循环.mp4"
      ></video>
    </div>
    ...
    ></div>
	<div class="zhileng1 cur" @click="$router.push({ path: '/shuniu1', query: $route.query })"></div>
    <img
