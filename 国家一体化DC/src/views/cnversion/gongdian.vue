  ...
  >
    <div class="video1container" v-if="lang && video1show">
      <video
        ...
        autoplay
        muted
        src="../../assets/videos/cn/OLF入场.mp4"
      ></video>
    </div>
    <div class="video2container" v-show="lang && video2show">
      <video
        ...
        loop
        muted
        src="../../assets/videos/cn/OLF循环.mp4"
      ></video>
    </div>
    ...
    <div class="video1container" v-if="!lang && video1show">
      <video
        ...
        autoplay
        muted
        src="../../assets/videos/en/OLF入场.mp4"
      ></video>
    </div>
    <div class="video2container" v-show="!lang && video2show">
      <video
        ...
        loop
        muted
        src="../../assets/videos/en/OLF循环.mp4"
      ></video>
    </div>
    ...
    <div
        class="gongdian cur"
        @click="$router.push({ path: '/shuniu1', query: $route.query })"
    ></div>
    <div
        class="qita cur"
        @click="$router.push({ path: '/qita', query: $route.query })"
    ></div>
	<div class="gongdian1 cur" @click="$router.push({ path: '/shuniu1', query: $route.query })"></div>
    <img
...
export default {
  ...
  created() {
    this.init()
    // localStorage.setItem("shuniu", false);
  },
};
</script>
